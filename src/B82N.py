...
print "#############  KMERS BASE 10 A BASE 4 (8bits por kmers) #################"
# OpenCL Things
...
B82N = programa.B82N
B82N.set_scalar_arg_dtypes([None, None, np.uint32, np.uint32,np.uint32])
...
B82N(cola, rango_global, None, d_SK_4, d_SK_2_8, k,c_sk_4, s)
cola.finish()
# Traigo datos
